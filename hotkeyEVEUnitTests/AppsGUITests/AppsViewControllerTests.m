...
- (void) test_awakeFromNib_contollerAllocated_callViewSelectiondDidChangeWithInstalledAppsView {
  ...
  [[appsViewControllerMock expect] viewSelectionDidChanged :[TGEVE_AppsTableViewController class] :kAppsTableViewControllerNibName :[TGEVE_AppsManagerAmazon class]];
...
- (void) test_viewSelectionDidChanged_allScenarios_addNewViewToTheMainContentView {
  ...
  [_appsViewController viewSelectionDidChanged:[TGEVE_AppsTableViewController class] :kAppsTableViewControllerNibName :[AppsManagerMock class]];
